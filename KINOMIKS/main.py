...
NOTSUB_MESSAGE = 'Для использования бота , подпишитесь на канал!'
...
async def update_news_films():
    ...
    for result in results:
        ...
        film_id = film_data['kinopoisk_id']
        try:
...
async def update_collections_films():
    ...
    for collection_items in collections['data'][41:]:
        ...
        await asyncio.sleep(15)
    current_date = date.today()
    await bot.send_message(chat_id=admin_id, text=f'✅ <b>{current_date}</b> | Обновление раздела <b>«Подборки»</b> успешно завершено.\n🎬 Добавлено: <b>{new_films_count}</b> видео.\n\n👉 @KINOMIKS_BOT')
...
async def send_welcome(message: types.Message, state: FSMContext):
    if message.chat.type == 'private':
        if check_sub_channel(await bot.get_chat_member(chat_id=channel_id, user_id=message.from_user.id)):
            ...
            text = f'<a href="https://i.ibb.co/ZM1J1ms/wallpaperflare-com-wallpaper-2.jpg">🎞️</a> <b><u>KINOMIKS</u></b> — уникальный КИНО бот, который даст Вам возможность <b>бесплатно</b> наслаждаться новинками кинематографа через <u>TELEGRAM</u>.'
            await bot.send_message(message.from_user.id, f'{text}', reply_markup=inlinekeyboard)
        else:
            await bot.send_message(message.from_user.id, NOTSUB_MESSAGE , reply_markup=checksubmemu)
...
async def popular_menu(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/y5vCx0y/wallpaperflare-com-wallpaper-7.jpg">🚀</a> Вы перешли в раздел <b>«Популярное»</b>, здесь находятся видеоматериалы, которые <b>популярны</b> на текущий год.\n\n<i>👉 Выберите <b>категорию</b>, в которой желаете выбрать <b>видеоматериал</b> для просмотра.</i>', reply_markup=popular_menu_kb)

# Новинки (Фильмы)
@dp.callback_query_handler(text="news_menu", state="*")
async def news_menu(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/HY1Rj1Z/wallpaperflare-com-wallpaper-6.jpg">🆕</a> Вы перешли в раздел <b>«Новинки»</b>, здесь находятся <b>новые</b> видеоматериалы, которые были <b>добавлены</b> в течении последних суток.\n\n<i>👉 Выберите <b>категорию</b>, в которой желаете выбрать <b>видеоматериал</b> для просмотра.</i>', reply_markup=news_menu_kb)
...
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/mzqZXT7/wallpaperflare-com-wallpaper-16.jpg">🔍</a> Вы перешли в раздел <b>«Поиск»</b>, пожалуйста, выберите <b>тип поиска</b>, которым желаете воспользоваться.', reply_markup=search)

@dp.callback_query_handler(text="categories", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/Mn91vQ8/wallpaperflare-com-wallpaper-17.jpg">🔍</a> Вы перешли в раздел <b>«Поиск по названию»</b>, пожалуйста, выберите <b>категорию</b>, в которой желаете найти <b>видеоматериал</b>.', reply_markup=category)
...
async def send(call: types.CallbackQuery):
    ...
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/DLrgtyt/wallpaperflare-com-wallpaper-15.jpg">🎞️</a> Вы перешли в раздел <b>«Подборки»</b>, пожалуйста, выберите <b>подборку</b>, в которой желаете выбрать <b>видеоматериал</b> для просмотра.', reply_markup=kb)
...
async def send(call: types.CallbackQuery):
  await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/QQP2374/wallpaperflare-com-wallpaper-20.jpg">🎞️</a> <b><u>KINOMIKS</u></b> — <b>первый онлайн-кинотеатр</b> в Telegram, который предоставляет возможность <b><u>бесплатно</u></b> наслаждаться новинками  кинематографа.\n\n💡 <b>Основные возможности бота:</b>\n— Удобный поиск фильмов, сериалов, ТВ-шоу, мультфильмов и т.п. по названию;\n— <b>Подборки</b> видеоматериалов;\n— Удобный плеер;\n— Высокое качество каждого видеоматериала;\n— Ежедневное пополнение новинками кино.', reply_markup=about)

@dp.callback_query_handler(text="contacts", state="*")
async def send(call: types.CallbackQuery):
  await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<b><a href="https://i.ibb.co/0mK4nzQ/wallpaperflare-com-wallpaper-19.jpg">🔥</a> Мы всегда рады новым идеям и предложениям, которые будут полезны для нашей площадки!</b>\n\n📌 ', reply_markup=contacts)
...
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/wgNsrwf/wallpaperflare-com-wallpaper-18.jpg">🆔</a> Пожалуйста, введите и отправьте <b>ID видеоматериала</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте корректный ID, да бы избежать неверную выдачу видеоматериала.</i>', reply_markup=go_poisk)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
     ...
     response = requests.get("https://api1644392427.bhcesh.me/franchise/details?token=4c250f7ac0a8c8a658c789186b9a58a5&kinopoisk_id={message.text}",params=params).json()
     name = response['name']
     film_id = response['kinopoisk_id']
     ...
     play.add(types.InlineKeyboardButton(text="😍 Смотреть онлайн", url=f'https://kinopoisk-watch-dsze5.ondigitalocean.app/player/?id={film_id}'))
...
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/5TgQVCP/wallpaperflare-com-wallpaper-10.jpg">🔎</a> Укажите оригинальное название <b>фильма</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard2)
            ...
            try:
                if str(response).count('activate_time') > 1:
                    ...
                    async def handle_text(message: types.Message, state: FSMContext):
                        ...
                        film_id = response[int(message.text)]['kinopoisk_id']
                ...
                await message.answer('<a href="https://i.ibb.co/5s8ZsqB/wallpaperflare-com-wallpaper-5.jpg">😔</a> Не удалось найти <b>фильм</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard2)
                await state.finish()

@dp.callback_query_handler(text="serials", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/S3ZDtwD/wallpaperflare-com-wallpaper-9.jpg">🔎</a> Укажите оригинальное название <b>сериала</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard3)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                await message.answer('<a href="https://i.ibb.co/5s8ZsqB/wallpaperflare-com-wallpaper-5.jpg">😔</a> Не удалось найти <b>сериал</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard3)
                await state.finish()

@dp.callback_query_handler(text="anime_films", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/tb3nCj9/wallpaperflare-com-wallpaper-11.jpg">🔎</a> Укажите оригинальное название <b>аниме-фильма</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard4)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                await message.answer('<a href="https://i.ibb.co/5s8ZsqB/wallpaperflare-com-wallpaper-5.jpg">😔</a> Не удалось найти <b>аниме-фильм</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard4)
                await state.finish()

@dp.callback_query_handler(text="cartoon_serials", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/9wNpcVz/wallpaperflare-com-wallpaper-14.jpg">🔎</a> Укажите оригинальное название <b>аниме-сериала</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard5)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                print(ex)
                await message.answer('<a href="https://i.ibb.co/5s8ZsqB/wallpaperflare-com-wallpaper-5.jpg">😔</a> Не удалось найти <b>мультсериал</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard5)
                await state.finish()

@dp.callback_query_handler(text="cartoon", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/kQj8dXT/wallpaperflare-com-wallpaper-13.jpg">🔎</a> Укажите оригинальное название <b>мультфильма</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard6)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                await message.answer('<a href="https://i.ibb.co/5s8ZsqB/wallpaperflare-com-wallpaper-5.jpg">😔</a> Не удалось найти <b>мультфильм</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard6)
                await state.finish()

@dp.callback_query_handler(text="anime_serials", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/tb3nCj9/wallpaperflare-com-wallpaper-11.jpg">🔎</a> Укажите оригинальное название <b>аниме-сериала</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard7)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                await message.answer('<a href="https://i.ibb.co/5s8ZsqB/wallpaperflare-com-wallpaper-5.jpg">😔</a> Не удалось найти <b>аниме-сериал</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard7)
                await state.finish()

@dp.callback_query_handler(text="tv", state="*")
async def send(call: types.CallbackQuery):
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '<a href="https://i.ibb.co/cgynbrF/wallpaperflare-com-wallpaper-8.jpg">🔎</a> Укажите оригинальное название <b>ТВ-шоу</b> для поиска.\n\n❗<i><b>Важно:</b> указывайте точное название для корректного поиска.</i>', reply_markup=inlinekeyboard8)
    ...
    async def handle_text(message: types.Message, state: FSMContext):
            ...
            try:
                ...
                await message.answer('<a href="https://i.ibb.co/5s8ZsqB/wallpaperflare-com-wallpaper-5.jpg">😔</a> Не удалось найти <b>ТВ-Шоу</b> с подобным названием.\n\n❗<i>Введите корректное название для более точного поиска.</i>', reply_markup=inlinekeyboard8)
                await state.finish()

@dp.message_handler(content_types=['text'])
async def send_all(message):
  await bot.send_message(message.from_user.id, f'❗К сожалению, ваш запрос не распознан!\n\n<a href="https://i.ibb.co/JqBzwnB/wallpaperflare-com-wallpaper-3.jpg">🏠</a> <i>Вернитесь в <b>главное меню</b></i>.', reply_markup=exit)

@dp.callback_query_handler(text="back", state="*")
async def back(call: types.CallbackQuery, state: FSMContext):
    await state.finish()
    await bot.edit_message_text(chat_id=call.message.chat.id, message_id=call.message.message_id, text= '🏠 Вы вернулись в <b>главное меню</b>.\n\n<a href="https://i.ibb.co/6m4TWk8/wallpaperflare-com-wallpaper-4.jpg">🎦</a> Здесь вы можете выбрать <b>раздел</b>, в котором желаете найти или выбрать видеоматериал для просмотра.', reply_markup=inlinekeyboard, inline_message_id=call.inline_message_id)

async def on_startup(dp: Dispatcher):
    print('~~~ Bot успешно запущен! ~~~')
    print('~~~ Заходи к нам в канал ~~~')
    print('~~~ url - https://t.me/KINOMIKSED ~~~')
